...
from ARCHIVE.utils import make_clean_dirs, pickle_load, pickle_save
...
class DisagreementTrajectory(object):
    def __init__(self, a1_states, a2_states, disagreement_importance, states_importance):
        self.disagreement_index = a1_states[(len(a1_states)//2)-1].name
        ...
        self.importance = {
            ...
            'sum': 0,
            'avg_delta': 0,
            'last_state': states_importance[-1],
        }
